    ...
    extend: {
      colors: {
        ...
        default: {
          ...
          150: "hsl(var(--default-150) / <alpha-value>)",
          ...
          1000: "hsl(var(--default-1000) / <alpha-value>)",
      ...
      boxShadow: {
        base: "0px 1px 2px 0 rgba(228, 229, 231, 0.24)", // use
        base2: "0px 1px 2px 0 rgba(220, 43, 11, 0.05)", // use
        hover: "0px 2px 6px 0 rgba(228, 229, 231, 0.14)",
