...
type TStatus = Exclude<TGuestListArgs, void>["status"] | undefined;
type TGender = Exclude<TGuestListArgs, void>["sex"] | undefined;
...
function FilterForm({
  ...
  const { updateMultipleParam, deleteAParam, getAllParamValue } =
    manageStateParams;
  const { status, sex, numberOfTickets, ticketTierId, promoterId } =
    getAllParamValue();
