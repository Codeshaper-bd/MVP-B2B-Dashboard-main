...
const data: ChecklistCardProps[] = [
  {
    icon: <UserCircleIcon className="size-7 text-default-1000" />,
    iconColor: "#EAAA08",
  ...
  {
    icon: <UserCircle2Icon className="size-7 text-default-1000" />,
    iconColor: "#DD2590",
  ...
  {
    icon: <BarChartIcon className="size-7 text-default-1000" />,
    iconColor: "#1570EF",
...
function LinkCards() {
  return (
    <div className="py-6">
      <h2 className="text-center text-2xl font-semibold text-default-1000">
        Configure
      </h2>
