...
interface GuestListFilterProps {
  ...
  /* manageStateParamsProps: TUseManageStateParamsReturnType<
    Exclude<TGetPromotersTicketSoldListArgs, void>
  >; */
...
type GuestListFilterForm = Partial<TGetPromotersTicketSoldListArgs>;
...
export default function GuestListFilter({
  ...
  const onApply = (data: GuestListFilterForm) => {
    const updates: Partial<TGetPromotersTicketSoldListArgs> = {
      ...data,
      page: undefined,
    };
