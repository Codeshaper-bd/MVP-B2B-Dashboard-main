...
export const prepareCreateEventData = async ({
  ...
  const formData: TCreateAnEventArgs = {
    ...
    // isFreeGuestList: eventDetails.isFreeGuestList,
    ...
    // tax
    isTaxEnabled: eventDetails.isTaxEnabled ?? false,
    taxId: eventDetails.isTaxEnabled ? (eventDetails.taxId ?? "") : "",
    taxName: eventDetails.isTaxEnabled ? (eventDetails.taxName ?? "") : "",
    taxRate: eventDetails.isTaxEnabled ? (eventDetails.taxRate ?? 0) : 0,
  };
  ...
  // gratuity
  if (
    eventDetails.isGratuity &&
    eventDetails.gratuityValue !== null &&
    eventDetails.gratuityValue !== undefined &&
    typeof eventDetails.gratuityValue === "number"
  ) {
    (formData.isGratuity as TRequiredGratuity["isGratuity"]) =
      eventDetails.isGratuity;
    (formData.gratuityValue as unknown as TRequiredGratuity["gratuityValue"]) =
      eventDetails.gratuityValue;
  } else if (!eventDetails.isGratuity) {
