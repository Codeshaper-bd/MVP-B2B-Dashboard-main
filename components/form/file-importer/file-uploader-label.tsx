...
function FileUploaderLabel() {
  return (
    <Card className="flex h-full w-full cursor-pointer flex-col items-center justify-center py-5 shadow-none">
      <CardContent className="flex flex-col items-center px-6 py-4">
        ...
        <div className="mt-1 text-xs text-default-600">XLSX , XLS, or XLSM</div>
      </CardContent>
    </Card>
  );
}
