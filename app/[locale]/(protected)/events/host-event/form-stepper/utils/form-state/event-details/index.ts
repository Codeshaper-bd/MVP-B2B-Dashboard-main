...
export const prepareEventDetailsFormStateData = async ({
  ...
  if (
    ...
    getAnEventData?.details?.gratuityValue !== null &&
    getAnEventData?.details?.gratuityValue !== undefined &&
    typeof getAnEventData?.details?.gratuityValue === "number"
  ) {
    eventDetails.isGratuity = true;
    eventDetails.gratuityValue = getAnEventData?.details?.gratuityValue;
  } else if (!getAnEventData?.details?.isGratuity) {
    eventDetails.isGratuity = false;
    eventDetails.gratuityValue = 0;
  }
