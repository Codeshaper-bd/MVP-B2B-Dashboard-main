        ...
        <Card>
          ...
          <CardContent>
            <ApexDonutChart
              ...
              series={[ticketRevenue?.value ?? 0, barRevenue?.value ?? 0]}
...
export default EventTwoContent;
