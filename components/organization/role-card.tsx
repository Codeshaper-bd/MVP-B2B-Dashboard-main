...
const getRoleImage = (role: string) => {
  switch (role) {
    case "VIP Host":
      return "/images/organization/roles-bg-1.png";
    case "Admin":
      return "/images/organization/roles-bg-2.png";
    case "Bar tender":
      return "/images/organization/roles-bg-3.png";
    case "Coat Check":
      return "/images/organization/roles-bg-4.png";
    case "Promoter":
      return "/images/organization/roles-bg-5.png";
    default:
      return "/images/organization/roles-bg-1.png";
  }
};

function RoleCard({ name: role, userCount }: TRole) {
