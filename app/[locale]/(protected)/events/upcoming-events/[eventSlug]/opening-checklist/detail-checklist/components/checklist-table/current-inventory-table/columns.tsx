      ...
      <Table>
        <TableHeader className="border-none bg-secondary [&_tr]:border-t-0">
          <TableRow>
            ...
            <TableHead className="py-2.5">Predicted Opened Count</TableHead>
            <TableHead className="py-2.5">Actual Opened Count</TableHead>
            <TableHead className="py-2.5">Predicted Closed Count</TableHead>
            <TableHead className="py-2.5">Actual Closed Count</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          <TableRow>
            <TableCell className="lowercase">26 oz</TableCell>
