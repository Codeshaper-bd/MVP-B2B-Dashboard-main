...
import { useGetFennecLiveB2BPromotionsQuery } from "@/store/api/fennec-live/fennec-live-api";
    ...
    <DefaultTable data={getPromotionsData} columns={columns}>
      ...
      <div className="min-h-[240px]">
        <RenderData
          ...
          {...getPromotionsApiState}
          loadingSkeleton={<TableSkeleton />}
          dataNotFoundTitle="No promotions found"
          dataNotFoundSubtitle="There are no promotions running for this event."
        >
          <DefaultTable.Table />
        </RenderData>
      </div>
...
export default LivePromotionsTable;
