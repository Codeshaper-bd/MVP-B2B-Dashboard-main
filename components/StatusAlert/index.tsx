...
import BgRings from "../ui/BgRings";
    ...
    closeButtonContent = (
      <AlertDialogCancel asChild>
        <Button
          color="secondary"
          className={cn(
            "absolute right-6 !h-auto border border-default-100 border-opacity-0 bg-transparent !p-0 text-[#85888E] transition-all duration-300 ease-linear hover:border hover:border-opacity-0 hover:bg-transparent hover:text-primary focus:border",
            {},
          )}
          type="button"
          onClick={
        ...
        >
          <CrossIcon className="size-5 bg-transparent text-inherit" />
        </Button>
      </AlertDialogCancel>
    );
  }
