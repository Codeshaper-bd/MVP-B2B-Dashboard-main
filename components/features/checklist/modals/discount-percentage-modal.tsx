...
function DiscountPercentageDialog({
  open,
  setOpen,
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      <AlertDialogTrigger asChild>
        <Button size="icon" color="secondary">
          <PercentageIcon className="size-5" />
        </Button>
      </AlertDialogTrigger>
          ...
          <div className="w-full space-y-4">
            ...
            <div>
              <Input
                label="Enter Percent (%)"
                placeholder="0"
                rightContent={<span className="text-base font-normal">%</span>}
              />
            </div>
          </div>
...
export default DiscountPercentageDialog;
