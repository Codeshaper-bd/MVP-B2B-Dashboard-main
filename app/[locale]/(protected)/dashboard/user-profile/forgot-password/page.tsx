...
export const metadata = getSeoMeta({ title: "Forget password" });
          ...
          <div className="flex h-full flex-col">
            <div className="z-10 mx-auto mb-3 mt-16 flex w-full max-w-[524px] flex-col justify-center p-7 text-2xl text-default-900 md:px-[42px] md:py-[44px]">
              ...
              <div className="mb-6 text-center">
                <h4 className="mb-2 text-2xl font-medium text-default-900">
                  Forgot password?
                </h4>
              ...
              <ForgotPass forwardUrl="/dashboard/user-profile/otp-verification" />
